...
def drone():
    ...
    # =========================================================================================
    redis_server.hset(droneID, "IP", droneIP)
    redis_server.hset(droneID, 'longitude', drone_longitude)
    redis_server.hset(droneID, "latitude", drone_latitude)
    redis_server.hset(droneID, "status", drone_status)
